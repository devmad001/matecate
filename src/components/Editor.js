        ...
        {[0, 1, 2, 3].map((value) => {
            ...
            >
                ...
                <div className={checked.indexOf(value) !== -1 ? "light" : "dark"}>
                    <Box component="section" sx={{ p: 2 }} onClick={() => {
                        setValue(value);
                    }}>
                        {
                            editvalue != value ?
                            ...
                            : <Grid container spacing={2}>
                                ...
                                <Grid item xs={6}>
                                    <textarea rows={5} className='textarea' defaultValue={"Création d'applications BI avec QlikView, Tableau et Power BI pour le marketing, l'acquisition de clients, le CRM, les jeux responsables, les paiements et les finances."}></textarea>
